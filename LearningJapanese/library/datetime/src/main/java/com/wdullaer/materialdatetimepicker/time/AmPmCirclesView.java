...
public class AmPmCirclesView extends View {
    ...
    public void onDraw(Canvas canvas) {
        ...
        if (!mDrawValuesReady) {
            ...
            layoutYCenter += mAmPmCircleRadius * 1 / 2;
            int textSize = mAmPmCircleRadius * 1 / 2;
            ...
            // of the main circle.
            mAmXCenter = layoutXCenter - circleRadius + mAmPmCircleRadius * 1 / 2;
            mPmXCenter = layoutXCenter + circleRadius - mAmPmCircleRadius * 1 / 2;
