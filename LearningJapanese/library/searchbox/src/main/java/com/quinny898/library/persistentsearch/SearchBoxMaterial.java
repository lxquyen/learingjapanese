...
/**
 * Created by Quanpv on 25/7/2016.
 */

public class SearchBoxMaterial extends RelativeLayout {
    ...
    private final static String KEY_RESULT = "key_result_" + SearchBoxMaterial.class.getSimpleName();
     ...
     */
    public SearchBoxMaterial(Context context) {
        this(context, null);
    }
     ...
     */
    public SearchBoxMaterial(Context context, AttributeSet attrs) {
     ...
     */
    public SearchBoxMaterial(final Context context, AttributeSet attrs, int defStyle) {
...
//        }
    ...
    private void revealFrom(float x, float y, Activity a, SearchBoxMaterial s) {
