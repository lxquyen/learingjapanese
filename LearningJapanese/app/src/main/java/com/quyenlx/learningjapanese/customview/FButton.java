package com.quyenlx.learningjapanese.customview;
...
public class FButton extends Button implements View.OnTouchListener {
    ...
    private int buttonColor = 0xFFBD0400;
    private int shadowColor = 0x8B0000;
    ...
    private void parseAttrs(Context context, AttributeSet attrs) {
        ...
        for (int i = 0; i < typedArray.getIndexCount(); i++) {
            ...
            if (attr == R.styleable.FButton_shadowEnabled) {
                ...
                mButtonColor = typedArray.getColor(attr, buttonColor);
...
//                mShadowColor = typedArray.getColor(attr, R.color.fbutton_default_shadow_color);
                mShadowColor = typedArray.getColor(attr, shadowColor);
        ...
        mPaddingRight = ta.getDimensionPixelSize(getResources().getInteger(R.integer.fb_padding_index), 0);
        ta.recycle();
        ...
        mPaddingBottom = ta1.getDimensionPixelSize(getResources().getInteger(R.integer.fb_padding_index), 0);
        ta1.recycle();
    }
